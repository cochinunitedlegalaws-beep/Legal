...
class Tasks extends amplify_core.Model {
  ...
  const Tasks._internal({required this.id, title, description, assigned_to, status, due_date, data, createdAt, updatedAt}): _title = title, _description = description, _assigned_to = assigned_to, _status = status, _due_date = due_date, _data = data, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Tasks({String? id, String? title, String? description, int? assigned_to, String? status, String? due_date, String? data}) {
  ...
  Tasks copyWith({String? title, String? description, int? assigned_to, String? status, String? due_date, String? data}) {
    return Tasks._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'description': _description, 'assigned_to': _assigned_to, 'status': _status, 'due_date': _due_date, 'data': _data, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
