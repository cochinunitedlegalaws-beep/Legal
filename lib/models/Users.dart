...
class Users extends amplify_core.Model {
  ...
  const Users._internal({required this.id, username, password, role, name, email, data, createdAt, updatedAt}): _username = username, _password = password, _role = role, _name = name, _email = email, _data = data, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Users({String? id, String? username, String? password, String? role, String? name, String? email, String? data}) {
  ...
  Users copyWith({String? username, String? password, String? role, String? name, String? email, String? data}) {
    return Users._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'username': _username, 'password': _password, 'role': _role, 'name': _name, 'email': _email, 'data': _data, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
